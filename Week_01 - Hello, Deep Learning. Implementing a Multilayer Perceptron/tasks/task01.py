...
def main():
    ...
    print(f"Sunday analysis: \n Baseball Array: {baseball_np} \n Type of baseball array: {type(baseball_np)}")
    ...
    np_height_metres = np.multiply(np_height_in, 0.0254)

    print(f"Monday Analysis: \n np_height_in=array({np_height_in}, shape={np_height_in.shape}) \n np_height_metres=array({np_height_metres}, shape={np_height_metres.shape})")
